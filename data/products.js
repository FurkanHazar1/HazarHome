...
export const testFurnitureProducts = [
  // Oturma Odası Takımları (Ana kategori ürünleri)
  {
    ...
    type: "furniture_set",
    brand: "HazarHome Premium",
    description: "Günümüz yaşam tarzına uygun, konforlu ve şık tasarımıyla öne çıkan modern oturma odası takımı. Yüksek kaliteli kumaş döşeme ve sağlam ahşap iskelet yapısıyla uzun yıllar kullanım imkanı sunar. Ergonomik tasarımı sayesinde maksimum konfor sağlarken, modern çizgileriyle evinizin dekorasyonuna değer katar.",
    features: [
      "Yüksek kaliteli kumaş döşeme",
      "Sağlam ahşap iskelet yapısı", 
      "Ergonomik tasarım",
      "Çıkarılabilir koltuk minderleri",
      "Lekelere karşı dayanıklı kumaş"
    ],
    material: "Premium kumaş döşeme, masif ahşap iskelet",
    care: "Kuru temizlik önerilir, doğrudan güneş ışığından koruyunuz",
    careInstructions: [
      "Düzenli olarak elektrikli süpürge ile temizleyiniz",
      "Sıvı dökülmesi durumunda hemen temiz bezle siliniz", 
      "Doğrudan güneş ışığından koruyunuz",
      "Yılda bir kez profesyonel temizlik yaptırınız"
    ],
    ...
    images: [
      {
        src: "/images/products/furniture-1.jpg",
        alt: "Modern Oturma Odası Takımı - Ana görsel",
        type: "main_image",
        sortOrder: 1
      },
      {
        src: "/images/products/furniture-2.jpg", 
        alt: "Modern Oturma Odası Takımı - Alternatif renk",
        type: "gallery",
        sortOrder: 2
      }
    ],
  ...
  },
  {
    ...
    category: "oturma-odasi-takimlari",
    type: "furniture_set",
    brand: "HazarHome Luxury",
    description: "Prestijli yaşam alanları için tasarlanmış lüks oturma odası takımı. Premium kalite deri kaplama ve el işçiliği detaylarıyla zarafeti evinize taşır. Klasik ve modern tasarımı birleştiren zarif bir seçim. Uzun yıllar boyunca konfor ve şıklığı bir arada sunan eşsiz bir mobilya takımı.",
    features: [
      "%100 hakiki deri kaplama",
      "El işçiliği detayları",
      "Masif ahşap iskelet",
      "Çelik yay sistemi",
      "Nefes alan deri özelliği"
    ],
    material: "Hakiki deri, masif ceviz ahşabı",
    care: "Deri bakım kremi ile yılda 2 kez bakım yapınız",
    careInstructions: [
      "Yumuşak kuru bez ile siliniz",
      "Deri bakım ürünleri kullanınız",
      "Doğrudan ısı kaynaklarından uzak tutunuz",
      "Yılda 2 kez profesyonel deri bakımı yaptırınız"
    ],
    dimensions: "Toplam: 400x220 cm, 3'lü koltuk: 230x100x90 cm",
    warranty: "5 Yıl Premium Garanti",
    properties: [
      { name: "Stil", value: "Lüks/Klasik" },
      { name: "Malzeme Tipi", value: "Hakiki Deri" },
      { name: "İskelet", value: "Masif Ceviz" },
      { name: "Yay Sistemi", value: "Çelik Yay" },
      { name: "El İşçiliği", value: "Premium Detay" }
    ],
    colors: [
      {
        id: "brown-10002",
    ...
    images: [
      {
        src: "/images/products/furniture-3.jpg",
        alt: "Lüks Oturma Odası Takımı - Ana görsel",
        type: "main_image",
        sortOrder: 1
      },
      {
        src: "/images/products/furniture-4.jpg",
        alt: "Lüks Oturma Odası Takımı - Detay",
        type: "gallery",
        sortOrder: 2
      }
    ],
  ...
  // ==========================================
  // ALT KATEGORİLER - FURNITURE ITEMS
  // ==========================================
  
  // OTURMA ODASI ALT KATEGORİLERİ (10100-10999)
  
  // Üçlü Koltuklar (10100-10199)
  {
    id: 10101,
    ...
    type: "furniture", 
    brand: "HazarHome",
    description: "Ergonomik tasarımı ve yüksek kaliteli sünger dolgusu ile maksimum konfor sağlayan üçlü koltuk. Modern yaşam alanları için ideal olan bu koltuk, dayanıklı kumaş kaplama ve sağlam metal iskelet yapısıyla uzun yıllar hizmet verir. Geniş oturma alanı sayesinde 3 kişi rahatça oturabilir.",
    features: [
      "Yüksek yoğunluklu sünger dolgu",
      "Dayanıklı kumaş kaplama",
      "Metal iskelet yapısı",
      "Ergonomik sırt desteği",
      "Kolay montaj sistemi"
    ],
    material: "Kaliteli kumaş, yüksek yoğunluklu sünger, metal iskelet",
    care: "Düzenli elektrikli süpürge kullanınız",
    careInstructions: [
      "Haftada bir elektrikli süpürge ile temizleyiniz",
      "Leke çıkarma işlemi için kuru temizlik",
      "Doğrudan güneş ışığından koruyunuz",
      "Yük dağılımını eşit yapınız"
    ],
    dimensions: "200x90x85 cm (GenişlikxDerinlikxYükseklik)",
    warranty: "2 Yıl Üretici Garantisi",
    properties: [
      { name: "Stil", value: "Modern" },
      { name: "Malzeme Tipi", value: "Kumaş" },
      { name: "İskelet", value: "Metal" },
      { name: "Dolgu", value: "Yüksek Yoğunluklu Sünger" },
      { name: "Kapasite", value: "3 Kişi" }
    ],
    colors: [
      {
        id: "blue-10101",
    ...
    images: [
      {
        src: "/images/products/furniture-5.jpg",
        alt: "Rahat Üçlü Koltuk - Ana görsel",
        type: "main_image",
        sortOrder: 1
      },
      {
        src: "/images/products/furniture-6.jpg",
        alt: "Rahat Üçlü Koltuk - Yan görünüm",
        type: "gallery",
        sortOrder: 2
      }
    ],
  ...
  // İkili Koltuklar (10110-10119)
  {
    id: 10102,
    imgSrc: "/images/products/furniture/sofa-2.jpg",
    imgHoverSrc: "/images/products/furniture/sofa-2-hover.jpg",
    title: "Şık İkili Koltuk",
    price: 8500,
    category: "ikili-koltuklar",
    type: "furniture",
    description: "Şık tasarımı ve rahat oturumu ile 2 kişilik koltuk. Küçük alanlar için ideal.",
    colors: [
      {
        name: "Gri",
        value: "gri",
    ...
    images: [
      {
        src: "/images/products/furniture/sofa-2.jpg",
        alt: "Şık İkili Koltuk - Ana görsel",
        type: "main_image",
        sortOrder: 1
      }
    ],
    sizes: ["Standart"],
    filterCategories: ["ikili-koltuklar"],
    brand: "HazarHome",
    isAvailable: true,
  },

  // Berjer Koltuklar (10120-10129)
  {
    id: 10103,
    imgSrc: "/images/products/furniture/chair-1.jpg",
    imgHoverSrc: "/images/products/furniture/chair-1-hover.jpg",
    title: "Rahat Berjer Koltuk",
    price: 6500,
    category: "berjer-koltuklar",
    type: "furniture",
    description: "Tek kişilik rahat berjer koltuk. Okuma köşesi için mükemmel seçim.",
    colors: [
      {
        name: "Bej",
        value: "bej",
    ...
    images: [
      {
        src: "/images/products/furniture/chair-1.jpg",
        alt: "Rahat Berjer Koltuk - Ana görsel",
        type: "main_image",
        sortOrder: 1
      }
    ],
    sizes: ["Standart"],
    filterCategories: ["berjer-koltuklar"],
    brand: "HazarHome",
    isAvailable: true,
  },

  // Köşe Koltuklar (10200-10299)
  {
    id: 10201,
    ...
    type: "furniture",
    description: "Geniş oturma alanı sağlayan L şeklinde köşe koltuk. Modern yaşam alanları için ideal seçim.",
    colors: [
      {
        name: "Siyah",
        value: "siyah",
    ...
    properties: [
      ...
      { name: "Boyutlar", value: "L-Şekli 280x200 cm" },
      { name: "Garanti", value: "2 Yıl" },
      { name: "Üretim Yeri", value: "Türkiye" },
      { name: "Stil", value: "Modern" }
    ],
    images: [
      {
        src: "/images/products/furniture-7.jpg",
        alt: "L Şeklinde Köşe Koltuk - Ana görsel",
        type: "main_image",
        sortOrder: 1
      },
      {
        src: "/images/products/furniture-8.jpg",
        alt: "L Şeklinde Köşe Koltuk - Detay görsel",
        type: "gallery",
        sortOrder: 2
      }
    ],
  ...
  // Lüks Deri Koltuklar (10300-10399)
  {
    id: 10104,
    imgSrc: "/images/products/furniture/leather-sofa-3.jpg",
    imgHoverSrc: "/images/products/furniture/leather-sofa-3-hover.jpg",
    title: "Premium Deri Üçlü Koltuk",
    price: 18000,
    category: "uclu-koltuklar",
    type: "furniture",
    description: "Premium kalite deri kaplı 3 kişilik koltuk. Lüks ve konforun buluştuğu seçkin tasarım.",
    colors: [
      {
        name: "Kahverengi",
        value: "kahverengi",
    ...
    properties: [
      { name: "Malzeme", value: "Deri + Ahşap" },
      { name: "Boyutlar", value: "220x95x85 cm" },
      { name: "Garanti", value: "3 Yıl" },
      { name: "Üretim Yeri", value: "Türkiye" },
      { name: "Stil", value: "Lüks/Klasik" }
    ],
    images: [
      {
        src: "/images/products/furniture/leather-sofa-3.jpg",
        alt: "Premium Deri Üçlü Koltuk - Ana görsel",
        type: "main_image",
        sortOrder: 1
      }
    ],
  ...
  {
    id: 10105,
    imgSrc: "/images/products/furniture/leather-sofa-2.jpg",
    imgHoverSrc: "/images/products/furniture/leather-sofa-2-hover.jpg",
    title: "Premium Deri İkili Koltuk",
    price: 14000,
    category: "ikili-koltuklar",
    type: "furniture",
    description: "Premium kalite deri kaplı 2 kişilik koltuk. Zarif tasarım ve üstün konfor.",
    colors: [
      {
        name: "Kahverengi",
        value: "kahverengi",
    ...
    images: [
      {
        src: "/images/products/furniture/leather-sofa-2.jpg",
        alt: "Premium Deri İkili Koltuk - Ana görsel",
        type: "main_image",
        sortOrder: 1
      }
    ],
  ...
  {
    id: 10106,
    imgSrc: "/images/products/furniture/leather-chair.jpg",
    imgHoverSrc: "/images/products/furniture/leather-chair-hover.jpg",
    title: "Lüks Deri Berjer",
    price: 8500,
    category: "berjer-koltuklar",
    type: "furniture",
    description: "Lüks deri berjer koltuk. Klasik şıklığı modern konforla buluşturan özel tasarım.",
    colors: [
      {
        name: "Kahverengi",
        value: "kahverengi",
    ...
    images: [
      {
        src: "/images/products/furniture/leather-chair.jpg",
        alt: "Lüks Deri Berjer - Ana görsel",
        type: "main_image",
        sortOrder: 1
      }
    ],
  ...
  // YEMEK ODASI TAKIMLARI (20001-20099)
  {
    id: 20001,
    ...
    type: "furniture_set",
    description: "Klasik tasarımı ve sağlam yapısıyla uzun yıllar kullanabileceğiniz yemek odası takımı. Masa ve 6 sandalye dahil.",
    colors: [
      {
        name: "Ceviz",
        value: "ceviz",
    ...
    properties: [
      { name: "Malzeme", value: "Masif Ahşap" },
      { name: "Boyutlar", value: "Masa: 160x90, Sandalye: 6 Adet" },
      { name: "Garanti", value: "5 Yıl" },
      { name: "Üretim Yeri", value: "Türkiye" },
      { name: "Stil", value: "Klasik" }
    ],
    images: [
      {
        src: "/images/products/furniture-9.jpg",
        alt: "Klasik Yemek Odası Takımı - Ana görsel",
        type: "main_image",
        sortOrder: 1
      },
      {
        src: "/images/products/furniture-10.jpg",
        alt: "Klasik Yemek Odası Takımı - Detay",
        type: "gallery",
        sortOrder: 2
      }
    ],
    setItems: [
      { 
        name: "Yemek Masası", 
        quantity: 1, 
        description: "160x90 cm masif ahşap masa",
        price: 8000,
        image: "/images/products/furniture/dining-table.jpg",
        individualLink: "/product-detail-furniture/20101",
        properties: [
          { name: "Boyut", value: "160x90x75 cm" },
          { name: "Malzeme", value: "Masif Ahşap" }
        ]
      },
      { 
        ...
        quantity: 6, 
        description: "Klasik tasarım sandalye",
        price: 400,
        image: "/images/products/furniture/dining-chair.jpg",
        individualLink: "/product-detail-furniture/20102",
        properties: [
          { name: "Boyut", value: "45x50x95 cm" },
          { name: "Malzeme", value: "Ahşap + Kumaş" }
        ]
      }
    ],
  ...
  // Yemek Sandalyeleri (20110-20119)
  {
    id: 20102,
    imgSrc: "/images/products/furniture/dining-chair.jpg",
    imgHoverSrc: "/images/products/furniture/dining-chair-hover.jpg",
    title: "Klasik Yemek Sandalyesi",
    price: 400,
    category: "yemek-sandalyeleri",
    type: "furniture",
    description: "Klasik tasarım yemek sandalyesi. Rahat oturum ve sağlam yapısıyla uzun yıllar kullanım.",
    colors: [
      {
        name: "Ceviz",
        value: "ceviz",
    ...
    images: [
      {
        src: "/images/products/furniture/dining-chair.jpg",
        alt: "Klasik Yemek Sandalyesi - Ana görsel",
        type: "main_image",
        sortOrder: 1
      }
    ],
    sizes: ["Standart"],
    filterCategories: ["yemek-sandalyeleri"],
    brand: "HazarHome",
    isAvailable: true,
  },

  // YATAK ODASI TAKIMLARI (30001-30099)
  {
    id: 30001,
    imgSrc: "/images/products/furniture-13.jpg",
    ...
    type: "furniture_set",
    description: "Modern yatak odası takımı; yatak, komodin, gardırop ve şifonyerden oluşan komple set.",
    colors: [
      {
        name: "Lake",
        value: "lake",
    ...
    properties: [
      { name: "Malzeme", value: "MDF + Lamine" },
      { name: "Boyutlar", value: "Yatak: 160x200, Gardırop: 6 Kapılı" },
      { name: "Garanti", value: "3 Yıl" },
      { name: "Üretim Yeri", value: "Türkiye" },
      { name: "Stil", value: "Modern" }
    ],
    images: [
      {
        src: "/images/products/furniture-13.jpg",
        alt: "Şık Yatak Odası Takımı - Ana görsel",
        type: "main_image",
        sortOrder: 1
      },
      {
        src: "/images/products/furniture-1.jpg",
        alt: "Şık Yatak Odası Takımı - Detay",
        type: "gallery",
        sortOrder: 2
      }
    ],
    setItems: [
      { 
        name: "Yatak", 
        quantity: 1, 
        description: "160x200 cm çift kişilik yatak",
        price: 8500,
        image: "/images/products/furniture/bed.jpg",
        individualLink: "/product-detail-furniture/30101",
        properties: [
          { name: "Boyut", value: "160x200x25 cm" },
          { name: "Özellik", value: "Ortopedik" }
        ]
      },
      { 
        name: "Komodin", 
        quantity: 2, 
        description: "Yatak yanı komodin",
        price: 1200,
        image: "/images/products/furniture/nightstand.jpg",
        individualLink: "/product-detail-furniture/30102",
        properties: [
          { name: "Boyut", value: "50x40x60 cm" },
          { name: "Malzeme", value: "MDF + Lamine" }
        ]
      },
      { 
        name: "Gardırop", 
        quantity: 1, 
        description: "6 kapılı gardırop",
        price: 12000,
        image: "/images/products/furniture/wardrobe.jpg",
        individualLink: "/product-detail-furniture/30201",
        properties: [
          { name: "Boyut", value: "240x60x220 cm" },
          { name: "Kapı Sayısı", value: "6 Kapılı" }
        ]
      },
      { 
        name: "Şifonyer", 
        quantity: 1, 
        description: "Aynalı şifonyer",
        price: 3500,
        image: "/images/products/furniture/dresser.jpg",
        individualLink: "/product-detail-furniture/30103",
        properties: [
          { name: "Boyut", value: "120x45x180 cm" },
          { name: "Özellik", value: "Aynalı" }
        ]
      }
    ],
    sizes: ["Çift Kişilik"],
  ...
  // YATAK ODASI ALT KATEGORİLERİ (30100-30999)
  
  // Yataklar (30100-30199)
  {
    id: 30101,
    imgSrc: "/images/products/furniture-2.jpg",
    ...
    category: "yataklar",
    type: "furniture",
    description: "Ortopedik özellikli, yüksek kaliteli yatak. Sağlıklı uyku için ideal seçim.",
    colors: [
      {
        name: "Bej",
        value: "bej",
    ...
    properties: [
      { name: "Malzeme", value: "Ortopedik Yatak + Kumaş" },
      { name: "Boyutlar", value: "160x200x25 cm" },
      { name: "Garanti", value: "10 Yıl" },
      { name: "Üretim Yeri", value: "Türkiye" },
      { name: "Özellik", value: "Ortopedik" }
    ],
    images: [
      {
        src: "/images/products/furniture-2.jpg",
        alt: "Ortopedik Yatak - Ana görsel",
        type: "main_image",
        sortOrder: 1
      },
      {
        src: "/images/products/furniture-3.jpg",
        alt: "Ortopedik Yatak - Detay",
        type: "gallery",
        sortOrder: 2
      }
    ],
  ...
  // Komodinler (30110-30119)
  {
    id: 30102,
    imgSrc: "/images/products/furniture/nightstand.jpg",
    imgHoverSrc: "/images/products/furniture/nightstand-hover.jpg",
    title: "Yatak Yanı Komodini",
    price: 1200,
    category: "komodinler",
    type: "furniture",
    description: "Pratik yatak yanı komodini. Çekmeceli ve açık raflı tasarım.",
    colors: [
      {
        name: "Lake",
        value: "lake",
    ...
    properties: [
      { name: "Malzeme", value: "MDF + Lamine" },
      { name: "Boyutlar", value: "50x40x60 cm" },
      { name: "Garanti", value: "2 Yıl" },
      { name: "Üretim Yeri", value: "Türkiye" },
      { name: "Özellik", value: "Çekmeceli" }
    ],
    images: [
      {
        src: "/images/products/furniture/nightstand.jpg",
        alt: "Yatak Yanı Komodini - Ana görsel",
        type: "main_image",
        sortOrder: 1
      }
    ],
    sizes: ["Standart"],
    filterCategories: ["komodinler"],
    brand: "HazarHome",
    isAvailable: true,
  },

  // Şifonyerler (30120-30129)
  {
    id: 30103,
    imgSrc: "/images/products/furniture/dresser.jpg",
    imgHoverSrc: "/images/products/furniture/dresser-hover.jpg",
    title: "Aynalı Şifonyer",
    price: 3500,
    category: "sifonyerler",
    type: "furniture",
    description: "Aynalı şifonyer. Yatak odası için fonksiyonel ve şık çözüm.",
    colors: [
      {
        name: "Lake",
        value: "lake",
    ...
    images: [
      {
        src: "/images/products/furniture/dresser.jpg",
        alt: "Aynalı Şifonyer - Ana görsel",
        type: "main_image",
        sortOrder: 1
      }
    ],
    sizes: ["Standart"],
    filterCategories: ["sifonyerler"],
    brand: "HazarHome",
    isAvailable: true,
  },

  // Gardıroplar (30200-30299)
  {
    id: 30201,
    imgSrc: "/images/products/furniture/wardrobe.jpg",
    imgHoverSrc: "/images/products/furniture/wardrobe-hover.jpg",
    title: "6 Kapılı Modern Gardırop",
    price: 12000,
    category: "gardiroplar",
    type: "furniture",
    description: "6 kapılı modern gardırop. Geniş depolama alanı ve şık tasarım.",
    colors: [
      {
        name: "Lake",
        value: "lake",
    ...
    properties: [
      { name: "Malzeme", value: "MDF + Lamine" },
      { name: "Boyutlar", value: "240x60x220 cm" },
      { name: "Garanti", value: "3 Yıl" },
      { name: "Üretim Yeri", value: "Türkiye" },
      { name: "Kapı Sayısı", value: "6 Kapılı" }
    ],
    images: [
      {
        src: "/images/products/furniture/wardrobe.jpg",
        alt: "6 Kapılı Modern Gardırop - Ana görsel",
        type: "main_image",
        sortOrder: 1
      }
    ],
    sizes: ["4 Kapılı", "6 Kapılı"],
    filterCategories: ["gardiroplar"],
    brand: "HazarHome",
    isAvailable: true,
  },

  // Gardıroplar (Alt kategori) - ESKİ ÜRÜN
  {
    id: 10009,
    imgSrc: "/images/products/furniture-4.jpg",
    ...
    type: "furniture",
    description: "Geniş depolama alanı sunan 6 kapılı gardırop. Modern yatak odalarının vazgeçilmezi.",
    colors: [
      {
        name: "Beyaz",
        value: "beyaz",
    ...
    properties: [
      { name: "Malzeme", value: "MDF + Lamine" },
      { name: "Boyutlar", value: "240x60x200 cm" },
      { name: "Garanti", value: "2 Yıl" },
      { name: "Üretim Yeri", value: "Türkiye" },
      { name: "Kapı Sayısı", value: "6 Kapılı" }
    ],
    images: [
      {
        src: "/images/products/furniture-4.jpg",
        alt: "6 Kapılı Gardırop - Ana görsel",
        type: "main_image",
        sortOrder: 1
      },
      {
        src: "/images/products/furniture-5.jpg",
        alt: "6 Kapılı Gardırop - İç düzen",
        type: "gallery",
        sortOrder: 2
      }
    ],
