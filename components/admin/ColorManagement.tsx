                ...
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-3">
                    <input
                      ...
                      className={`flex-1 px-4 py-3 bg-gray-700 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 text-white placeholder-gray-400 ${
