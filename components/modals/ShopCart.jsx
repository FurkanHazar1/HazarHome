...
export default function ShopCart() {
  ...
  // WhatsApp ile sipariş gönderme fonksiyonu
  const sendWhatsAppOrder = () => {
    ...
    const phoneNumber = "905335191329"; // WhatsApp numarası
    ...
    cartProducts.forEach((product, index) => {
      ...
      message += `   Adet: ${product.quantity}\n`;
      
      // Renk bilgisi varsa ekle
      if (product.selectedColor) {
        message += `   Renk: ${product.selectedColor}\n`;
      }
      ...
      if (product.category) {
        ...
        if (typeof product.category === 'object' && product.category.categoryName) {
          ...
          categoryName = categoryInfo && categoryInfo.name ? categoryInfo.name : product.category;
        } else {
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="header">
            <div className="title fw-5">Alışveriş Sepetim</div>
            <span
                ...
                <div className="tf-mini-cart-bottom-wrap">
                  ...
                  <div className="tf-mini-cart-view-checkout">
                    <button
                      ...
                      className="tf-btn btn-fill animate-hover-btn radius-3 w-100 justify-content-center whatsapp-order-btn"
                      style={{ 
